defmodule Rocketpay.Accounts.Operation do
  ...
  def call(%{"id" => id, "value" => value}, operation) do
    # Criando uma operação com nome dinâmico para não perdermos o 'tracking' das 'changes' que já executaram
  ...
  # Função que gera uma string dinâmica (de acordo com a operação que está sendo executada)

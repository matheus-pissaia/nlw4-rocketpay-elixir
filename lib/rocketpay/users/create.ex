...
# Note que queremos criar um usuário que terá uma 'carteira'
# Para não fazer diversas chamadas ao banco de dados para lidar
# com essas criações, utilizaremos o Ecto.Multi para fazer tudo de uma vez só!
